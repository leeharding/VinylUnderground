...
class Ebizmarts_SagePaySuite_DirectPaymentController extends Mage_Core_Controller_Front_Action {
    ...
    public function saveOrderAction() {
        ...
        try {
			...
			Mage::log(print_r($resultData,true),null,'sgp.log');
			Mage::log($response_status,null,'sgp.log');
            ...
            if ($response_status == Ebizmarts_SagePaySuite_Model_Api_Payment :: RESPONSE_CODE_3DAUTH) {
				...
				Mage::log('Response 3d Auth',null,'sgp.log');
            ...
            } elseif ($response_status == Ebizmarts_SagePaySuite_Model_Api_Payment :: RESPONSE_CODE_APPROVED || $response_status == Ebizmarts_SagePaySuite_Model_Api_Payment :: RESPONSE_CODE_REGISTERED) {

				Mage::log('Response approved or register',null,'sgp.log');
		...
		Mage::log('--directpayment save order action -',null,'sgp.log');
		Mage::log(print_r($resultData,true),null,'sgp.log');
