 ...
 */
class Magecoders_Imagecdn_Model_Adapter_AmazonS3 extends Magecoders_Imagecdn_Model_Adapter_Abstract
{	
	/**
	 ...
	 *
	 * @return Magecoders_Imagecdn_Model_Adapter_AmazonS3_Wrapper
	 */
	...
	public function getProductImage($_product,$w=70){
